...
import six
from pyx_scrapy.utils.const import MetaK
...
def request_to_dict(request, spider=None):
    ...
    # url地址没有参数化，填充url项
    if request.meta.get(MetaK.ITEM_KWARGS) is None or 'redirect_urls' in request.meta:
...
def request_from_dict(d, spider=None):
    ...
    if not url and spider:
        url = spider.url_template.format(**d[MetaK.META].get(MetaK.ITEM_KWARGS, {}))
    else:
